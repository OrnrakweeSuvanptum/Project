...
public class Home extends JFrame {
	...
	public Home() {
		...
		LabelLogo.setBounds(-260, -14, 474, 185);
		panel_1.add(LabelLogo);
		LabelLogo.setIcon(new ImageIcon(Home.class.getResource("/feedback/HOMELOGO.jpg")));
		...
		LabelPicture1.setIcon(new ImageIcon(Home.class.getResource("/feedback/1.jpg")));
		LabelPicture1.setBounds(72, 280, 490, 457);
		panel.add(LabelPicture1);

		JLabel LabelPicture2 = new JLabel("");
		LabelPicture2.setIcon(new ImageIcon(Home.class.getResource("/feedback/2.jpg")));
